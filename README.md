...
В CMake 3.15 добавлена поддержка прямого вызова установки без использования родного инструмента сборки платформы. Чтобы воспользоваться этой возможностью, в качестве первого аргумента командной строки cmake нужно указать опцию `--install`, за которой следует путь каталога с собранным проектом. Можно указать и другие аргументы командной строки, чтобы определить, куда устанавливать, какие компоненты устанавливать, какую конфигурацию сборки использовать (в случае генераторов с несколькими конфигурациями) и выполнять ли зачистку перед установкой. Возможность указать эти дополнительные части информации является одной из основных причин использования этого метода в отличие от создания цели сборки. Следующие примеры демонстрируют удобство и гибкость:
